...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/amplify_auth_cognito/amplify_auth_cognito.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/amplify_secure_storage/amplify_secure_storage.framework"
